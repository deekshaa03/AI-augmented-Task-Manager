...
#     st.session_state.edit_task_id = None  # track currently edited task
...
#             with col2:
#                 priority = st.select_slider("Priority", options=range(1,6), value=3, help="1=High, 5=Low")
...
#                     reminder_datetime = datetime.combine(reminder_date, parsed_time).isoformat()
#                     payload = {
#                         "title": title,
...
#                                             st.session_state.edit_task_id = None  # close form
#                                             load_tasks()
#                                         else:
#                                             st.error(f"Error: {r.text}")
#                                     except Exception as e:
...
#                             st.session_state.edit_task_id = task['id']  # open form for this task
